...
public class BlackJack {
    ...
    /**
     * If a split is needed, this object holds the Player's split hand.
     */
    ...
    void startGame() {
        ...
        while (player.getChips() > 0 && isGame) {
            ...
            if (!playerHand.isBlackJack()) {
                ...
                if (playerHand.isStand() || (playerHand.isSplit() && splitHand.isStand())) {
                    performDealerHits();
                }
            }
    ...
    void resetHand() {
        ...
        if (playerHand.isSplit())
            dealtDeck.addAll(splitHand.getCards());
